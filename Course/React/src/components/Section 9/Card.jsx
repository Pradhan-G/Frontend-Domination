...
function Card({ img, artistName, songName, added, handleClick, index }) {
  return (
    <div className="bg-gray-500 h-[100px] w-[350px] rounded-lg flex gap-5 justify-between relative z-0">
      ...
      <button
        ...
        className="absolute bg-orange-600 h-[50px] w-[180px] rounded-lg  translate-x-[-50%] -translate-y-[-50%] bottom-0 z-10 left-1/2 hover:bg-orange-400 transition-all"
      >
