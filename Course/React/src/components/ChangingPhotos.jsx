    ...
    <div className="w-screen h-screen bg-zinc-700 flex justify-center items-center">
      <div className="w-1/2 h-1/2 bg-slate-900 rounded-md overflow-hidden flex relative">
        <img
          ...
          }  object-cover flex-shrink-0 transition-transform delay-700`}
        ...
        <img
          className={`h-full w-full ${
            count === 1 ? "-translate-x-[100%]" : "-translate-x-[200%]"
          } object-cover flex-shrink-0 transition-transform delay-700 `}
        ...
        <img
          className={`h-full w-full ${
            count === 2 ? "-translate-x-[200%]" : "-translate-x-[300%]"
          } object-cover flex-shrink-0 transition-transform delay-700`}
        ...
        <img
          className={`h-full w-full ${
            count === 3 ? "-translate-x-[300%]" : "-translate-x-[400%]"
          } object-cover flex-shrink-0 transition-transform delay-700`}
